...
export class Siders {
    static Add(Element) {
        ...
        const [R, G, B] = Api.Number.RgbToArray(Element.Color);
...
export class Notification {
    ...
    Append(Parent = null) {
        ...
        if (this.Notification.Events?.OnStart) {
            this.Notification.Events.OnStart();
        }
        ...
        if (!this.Notification.Options.AutoClose.Enabled) {
            const NotificationCloseButton = document.createElement("button");
            NotificationCloseButton.innerHTML = this.Notification.Options.CloseIcon;
            ...
            setTimeout(() => NotificationElement.remove(), this.Notification.Options.AutoClose.Timer);
        }
