                ...
                if (OtherParticle !== Particle) {
                    ...
                    if (!(ParticleRight < OtherParticleLeft || 
                        ...
                        if (Api.Particle.IsPlaceOccupied(NewPositionX, NewPositionY)) {
                            ...
                            const AverageTemp = (Temp + parseFloat(OtherParticle.getAttribute("Temp"))) / 2;
                            ...
                            if (!Particle.hasAttribute("Burning") && Particle.hasAttribute("Flammable") && JSON.parse(Particle.getAttribute("Flammable"))[0] && OtherParticle.hasAttribute("Incendiary")) {
                                ...
                                OtherParticle.setAttribute("Burning", true);
                                const FlammableData = JSON.parse(OtherParticle.getAttribute("Flammable"));
                                const Residue = FlammableData[1][Math.floor(Math.random() * FlammableData[1].length)];
