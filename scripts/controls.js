...
Api.MegcPlayButton.addEventListener("click", () => {
    Api.Particle.Plot.DrawArithmeticParticleGraph(Api.MegcInput.value || "Math.sin(x)", Position, Api.Particle.GetElement(Api.MegcSelector.value), MaxParticles, xMin, xMax, yMin, yMax, Api.MegcStepInput.number, true);
});
